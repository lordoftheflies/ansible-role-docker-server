...
[![Build Status](https://travis-ci.org/lordoftheflies/docker-server.svg?branch=master)](https://travis-ci.org/lordoftheflies/ansible-role-docker-server)

## Description

Docker-server is an Ansible Role used to setup and maintain production grade services.
...
* [On Ansible Galaxy](https://galaxy.ansible.com/lordoftheflies/ansible_role_docker-server)
...
* [example_docker-server.yml](files/example_site.yml) may contain an example entry.
